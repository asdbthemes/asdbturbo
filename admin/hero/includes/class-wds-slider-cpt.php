	...
	class WDS_Slider_CPT {
		...
		public function register_cpt() {
			register_post_type( 'wds-hero-slider', array(
				'labels'    => array(
					'name'               => _x( 'Hero Sliders', 'post type general name', 'asdbturbo' ),
					'singular_name'      => _x( 'Hero Slider', 'post type singular name', 'asdbturbo' ),
					'menu_name'          => _x( 'Hero Sliders', 'admin menu', 'asdbturbo' ),
					'name_admin_bar'     => _x( 'Hero Slider', 'add new on admin bar', 'asdbturbo' ),
					'add_new'            => _x( 'Add New', 'book', 'asdbturbo' ),
					'add_new_item'       => __( 'Add New Hero Slider', 'asdbturbo' ),
					'new_item'           => __( 'New Hero Slider', 'asdbturbo' ),
					'edit_item'          => __( 'Edit Hero Slider', 'asdbturbo' ),
					'view_item'          => __( 'View Hero Slider', 'asdbturbo' ),
					'all_items'          => __( 'All Hero Sliders', 'asdbturbo' ),
					'search_items'       => __( 'Search Hero Sliders', 'asdbturbo' ),
					'parent_item_colon'  => __( 'Parent Hero Sliders:', 'asdbturbo' ),
					'not_found'          => __( 'No Hero Slider found.', 'asdbturbo' ),
					'not_found_in_trash' => __( 'No Hero Slider found in Trash.', 'asdbturbo' )
				),
				'public'    => false,
				'show_ui'   => true,
		...
		public function images_cmb2_init() {
			...
			$box = new_cmb2_box( array(
				...
				'title'           => __( 'Hero Slider', 'asdbturbo' ),
			...
			$box->add_field( array(
				'name'            => __( 'Images', 'asdbturbo' ),
				'id'              => 'wds_hero_slider_images',
				'type'            => 'file_list',
				'desc'            => __( 'You do not need to create a slider if you intend to use a single image in your hero.', 'asdbturbo' ),
				'preview_size'         => array( 200, '200' ),
			) );

			$box->add_field( array(
				'name'            => __( 'Slider speed in seconds', 'asdbturbo' ),
				'id'              => 'wds_hero_slider_speed',
				'type'            => 'text',
				'sanitization_cb' => array( $this, 'sanitize_slider_speed' ),
				'desc'            => sprintf( __( 'Each image will slide in every %s seconds.', 'asdbturbo' ), '<code>&times</code>' ),
		...
		function slider_instructions( $slider_id ) {
			...
			<div style="clear: both;">
				<p><?php echo sprintf( __( 'Add this as a %s or using a shortcode.', 'asdbturbo' ), '<a href="widgets.php">Widget</a>' ); ?></p>

				<h5><?php _e( 'Primary Hero', 'asdbturbo' ); ?></h5>
				...
				<h5><?php _e( 'Secondary Hero', 'asdbturbo' ); ?></h5>
				...
				<h5><?php _e( 'Parallaxed Horizontal Hero', 'asdbturbo' ); ?></h5>
				...
				<p><em><?php _e( 'Note that the paralaxed version does not work with video. The layout of this option puts the button on the right, and the Heading on the left w/out the sub-heading.', 'asdbturbo' ); ?></em></p>

				<h5><?php _e( 'Adding a Video', 'asdbturbo' ); ?></h5>
				...
				<p><em><?php _e( 'The video is added using HTML5. Using a YouTube video is not supported.', 'asdbturbo' ); ?></em></p>

				<h5><?php _e( 'Adding an Overlay', 'asdbturbo' ); ?></h5>
