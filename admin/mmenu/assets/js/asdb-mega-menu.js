...
function show_statuses( mmtype ) {
		jQuery('.field-menu-item-' +mmtype ).show();
}


function asdb_mega_menu_renderMediaUploader( element_id ) {
	'use strict';
 ...
 * @since    0.2.0
 */
function asdb_mega_menu_resetUploadForm( $, element_id ) {
	'use strict';
 ...
 * @since    1.0.0
 */
function asdb_mega_menu_renderFeaturedImage( $, element_id ) {
