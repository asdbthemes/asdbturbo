...
gulp.task('clean:pot', function() {
	return del(['languages/asdbturbo.pot']);
});
...
gulp.task('wp-pot', ['clean:pot'], function() {
	...
	.pipe(wpPot({
		domain: 'asdbturbo',
		destFile:'asdbturbo.pot',
		package: 'asdbturbo',
		bugReport: 'https://asdbthemes.ru',
		lastTranslator: 'asdbThemes.ru <dev@wpbuild.ru>',
		team: 'asdbDev Team <dev@wpbuild.ru>'
	}))
...
gulp.task('watch', function() {
	...
	browserSync({
		...
		proxy: "http://turbonsk.asdbthemes.ru",    // Use https://asdbthemes.ru:3000 to use BrowserSync
		watchOptions: {
...
gulp.task('build', function(done) {
  sequence('copy',
          ['sprites', 'i18n', 'icons', 'styles', 'scripts', 'imagemin'],
          done);
});
